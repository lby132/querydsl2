...
public class QuerydslBasicTest {
    ...
    //연관관계 없는 엔티티 외부조인 회원의 이름이 팀 이름과 같은 대상 조인
    @Test
    ...
    @Test
    void findDtoByJPQL() {
        final List<MemberDto> resultList = em.createQuery("select new study.querydsl2.dto.MemberDto(m.username, m.age) from Member m", MemberDto.class)
                .getResultList();
